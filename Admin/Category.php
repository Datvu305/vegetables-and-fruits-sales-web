        ...
        <div class="main-panel">
            ...
            <div class="container">
                ...
                if (isset($_POST['txtsub'])) {
                    ...
                    $insert = $get_data->insert_cate(
                        $_POST['txtname'],
                        $_POST['txtdes']
                    );

                    if ($insert) {
                        echo "<script>alert('Thêm phân loại thành công');
                              </script>";
                    } else {
                ...
                ?>
                          ...
                          ?>
                                            <tr>
                                                ...
                                                <td><?php echo $se_cat['name_cat'] ?></td>
                                                <td><?php echo $se_cat['description'] ?></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" data-bs-toggle="modal"
                                                            data-bs-target="#updateRowModal"
                                                            class="btn btn-link btn-primary btn-lg">
                                                            <a href="updateCategory.php?id_cat=<?php echo $se_cat['id_cat'] ?>"
                                                                class="fa fa-edit"></a>
                                                        </button>
                                                        <button type="button" data-bs-toggle="tooltip" title=""
                                                            class="btn btn-link btn-danger"
                                                            data-original-title="Remove">
                                                            <a href="deleteCategory.php?del=<?php echo $se_cat['id_cat'] ?>"
