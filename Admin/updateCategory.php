                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $se_cat['name_cat']; ?>"
                                                        class="form-control" name="txtname" placeholder="" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Mô tả</label>
                                                    <textarea class="form-control" rows="3" name="txtdes"
                                                        required><?php echo $se_cat['description']; ?></textarea>
                                                </div>
                                            </div>
