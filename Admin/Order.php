...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <script>
            function setUpdateModal(id_order, status) {
            ...
            <!-- Modal -->
            <div class="modal fade" id="updateRowModal" tabindex="-1" aria-labelledby="updateRowModalLabel"
                aria-hidden="true">
                ...
                if(isset($_POST['id_order']) && isset($_POST['status'])){
                    ...
                    $update_status = $get_data->order_status($id_order, $status);
                    if($update_status){
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                ...
                                                <button type="button" class="btn btn-link btn-primary btn-lg"
                                                    ...
                                                    onclick="setUpdateModal('<?php echo $se['id_order']; ?>')">
