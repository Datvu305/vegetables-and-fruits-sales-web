...
if ($admin_role === null) {
    echo "<script>alert('Không tìm thấy thông tin admin');
        ...
        <div class="main-panel">
            ...
            <div class="container">
                ...
                ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <?php if ($admin_role == 1) { // Only Admin Level 1 can delete users ?>
                                            <button type="button" data-bs-toggle="tooltip" title=""
                                                class="btn btn-link btn-danger" data-original-title="Remove">
                                                <a href="delete_user.php?del=<?php echo $se['id_user']; ?>"
                                                    onClick="if(confirm('Bạn có chắc chắn muốn xóa?')) return true; else return false;"
                                                    class="fa fa-times"></a>
                                            </button>
                                            <?php } ?>
                                        </div>
                    ...
                    <?php if ($admin_role == 1) { // Only Admin Level 1 can manage Admin Level 2 ?>
                    <h4 class="page-title mt-4">Quản lý Nhân viên</h4>
                    <div class="table-responsive">
                        <table id="admin-table" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php 
                $select_admins = $get_user->select_admin(''); // Modify select_admin to fetch all admins with role 2
                $sql = "SELECT * FROM user_admin WHERE role=2";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <button type="button" data-bs-toggle="tooltip" title=""
                                                class="btn btn-link btn-danger" data-original-title="Remove">
                                                <a href="delete_admin.php?del=<?php echo $admin['id']; ?>"
                                                    onClick="if(confirm('Bạn có chắc chắn muốn xóa Admin này?')) return true; else return false;"
                                                    class="fa fa-times"></a>
                                            </button>
                                        </div>
                                    </td>
