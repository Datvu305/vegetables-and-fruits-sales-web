...
// Lấy ID từ URL và kiểm tra hợp lệ
$blog_id = isset($_GET['id']) ? (int)$_GET['id'] : 0;

// Lấy thông tin bài viết
$blog = $data->get_blog_by_id($blog_id);
...
$image_path = !empty($image) ? "../Admin/upload/" . htmlspecialchars($image) : 'img/blog/details/details-pic.jpg';
?>
                        <img src="<?php echo $image_path; ?>"
                            alt="<?php echo htmlspecialchars($blog['title'] ?? ''); ?>"
                            style="width: 669px; height: 447px; object-fit: cover;"
                            onerror="this.src='img/blog/details/details-pic.jpg'">

                        <h2><?php echo htmlspecialchars($blog['title']); ?></h2>

                        <ul class="blog__details__info">
                            <li><i class="fa fa-calendar-o"></i>
                                <?php echo date('M j, Y', strtotime($blog['created_at'])); ?></li>
                           
                        </ul>

                        <div class="blog__details__content">
    <?php 
    // Hiển thị toàn bộ nội dung mà không cắt
    echo $blog['content'];
    ?>
</div>
